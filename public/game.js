...
function drawAvatarPreview(type, color) {
  ...
  if (type === 'wizard') {
    ...
    ctx.fillStyle = dark;
    ctx.fillRect(4, 47, 11, 24); ctx.fillRect(65, 47, 11, 24);
    ctx.fillStyle = '#888';
    ctx.fillRect(4, 71, 4, 8); ctx.fillRect(9, 71, 4, 8);
    ctx.fillRect(65, 71, 4, 8); ctx.fillRect(70, 71, 4, 8);
    ctx.fillStyle = hex; ctx.fillRect(20, 20, 40, 28);
    ctx.fillStyle = '#ff3300'; ctx.fillRect(24, 28, 32, 10);
    ctx.fillStyle = 'rgba(255,50,0,0.4)'; ctx.fillRect(22, 26, 36, 14);
    ...
    ctx.fillStyle = '#888';
    ctx.fillRect(20, 68, 15, 26); ctx.fillRect(45, 68, 15, 26);
    ctx.fillStyle = hex;
    ctx.fillRect(22, 70, 11, 22); ctx.fillRect(47, 70, 11, 22);
    ctx.fillStyle = '#aaa'; ctx.fillRect(14, 42, 52, 30);
    ctx.fillStyle = hex; ctx.fillRect(18, 46, 44, 24);
    ctx.fillStyle = '#ffcc00'; ctx.fillRect(34, 48, 12, 16);
    ...
    ctx.fillStyle = '#888'; ctx.fillRect(24, 28, 32, 20);
    ctx.fillStyle = '#333'; ctx.fillRect(28, 30, 24, 10);
    ctx.fillStyle = 'rgba(50,150,255,0.6)'; ctx.fillRect(29, 31, 22, 8);
    ctx.fillStyle = '#cc2222';
    ctx.beginPath();
    ...
    ctx.fillRect(20, 78, 15, 16); ctx.fillRect(45, 78, 15, 16);
    ctx.fillStyle = '#8B6914';
    ctx.fillRect(22, 60, 13, 22); ctx.fillRect(45, 60, 13, 22);
    ctx.fillStyle = hex; ctx.fillRect(16, 38, 48, 26);
    ctx.strokeStyle = dark; ctx.lineWidth = 1.5;
    ctx.beginPath(); ctx.moveTo(40, 38); ctx.lineTo(40, 64); ctx.stroke();
    ctx.fillStyle = dark;
    ctx.fillRect(20, 50, 10, 8); ctx.fillRect(50, 50, 10, 8);
    ctx.fillStyle = '#5c3a1e'; ctx.fillRect(16, 60, 48, 5);
    ctx.fillStyle = '#ffcc00'; ctx.fillRect(35, 59, 10, 7);
    ctx.fillStyle = hex;
    ctx.fillRect(4, 40, 11, 22); ctx.fillRect(65, 40, 11, 22);
    ctx.fillStyle = '#5c3a1e';
    ctx.fillRect(4, 60, 11, 8); ctx.fillRect(65, 60, 11, 8);
    ctx.fillStyle = '#f5d5a0';
    ...
    ctx.fillStyle = '#8B6914'; ctx.fillRect(27, 9, 26, 8);
    ctx.fillStyle = '#ffcc00'; ctx.fillRect(26, 16, 28, 3);
    ctx.fillStyle = '#8B6914'; ctx.fillRect(56, 40, 14, 20);
    ctx.strokeStyle = dark; ctx.lineWidth = 1;
    ctx.strokeRect(58, 42, 10, 8); ctx.strokeRect(58, 52, 10, 6);
...
function makeAvatar(color, name, type) {
  ...
  const add = (geo, material, x, y, z, rx, ry, rz) => {
  ...
  if (type === 'wizard') {
    ...
    add(new THREE.SphereGeometry(0.14, 6, 4), mat(0x3a1a00),  0.18, 0.14, 0.1);
    add(new THREE.CylinderGeometry(0.5, 0.75, 1.2, 8), mat(color), 0, 0.8, 0);
    add(new THREE.CylinderGeometry(0.35, 0.5, 0.6, 8), mat(color), 0, 1.6, 0);
    ...
    add(new THREE.CylinderGeometry(0.1, 0.12, 0.7, 6), mat(color), -0.6, 1.55, 0, 0, 0, 0.4);
    add(new THREE.CylinderGeometry(0.1, 0.12, 0.7, 6), mat(color),  0.6, 1.55, 0, 0, 0, -0.4);
    ...
    add(new THREE.BoxGeometry(0.12, 0.03, 0.04), mat(0x888888),  0.14, 2.48, 0.33);
    add(new THREE.CylinderGeometry(0, 0.42, 0.9, 8), mat(Math.max(0, color - 0x222222)), 0, 3.05, 0);
    add(new THREE.CylinderGeometry(0.48, 0.48, 0.08, 8), mat(Math.max(0, color - 0x222222)), 0, 2.65, 0);
    ...
    add(new THREE.BoxGeometry(0.28, 0.12, 0.38), mat(dark), -0.18, 0.06, 0.05);
    add(new THREE.BoxGeometry(0.28, 0.12, 0.38), mat(dark),  0.18, 0.06, 0.05);
    add(new THREE.BoxGeometry(0.22, 0.5, 0.22), mat(dark), -0.18, 0.37, 0);
    add(new THREE.BoxGeometry(0.22, 0.5, 0.22), mat(dark),  0.18, 0.37, 0);
    add(new THREE.SphereGeometry(0.13, 6, 6), mat(0x888888), -0.18, 0.65, 0);
    add(new THREE.SphereGeometry(0.13, 6, 6), mat(0x888888),  0.18, 0.65, 0);
    add(new THREE.BoxGeometry(0.24, 0.4, 0.24), mat(color), -0.18, 0.9, 0);
    add(new THREE.BoxGeometry(0.24, 0.4, 0.24), mat(color),  0.18, 0.9, 0);
    add(new THREE.BoxGeometry(0.6, 0.2, 0.4), mat(dark), 0, 1.12, 0);
    add(new THREE.BoxGeometry(0.72, 0.7, 0.48), mat(color), 0, 1.6, 0);
    add(new THREE.BoxGeometry(0.4, 0.3, 0.08), mat(dark), 0, 1.65, 0.25);
    ...
    add(new THREE.BoxGeometry(0.06, 0.3, 0.12), mat(dark), -0.38, 1.55, 0.1);
    add(new THREE.BoxGeometry(0.06, 0.3, 0.12), mat(dark),  0.38, 1.55, 0.1);
    add(new THREE.SphereGeometry(0.18, 8, 8), mat(0x888888), -0.54, 1.9, 0);
    add(new THREE.SphereGeometry(0.18, 8, 8), mat(0x888888),  0.54, 1.9, 0);
    add(new THREE.BoxGeometry(0.22, 0.5, 0.22), mat(color), -0.6, 1.55, 0);
    add(new THREE.BoxGeometry(0.22, 0.5, 0.22), mat(color),  0.6, 1.55, 0);
    add(new THREE.SphereGeometry(0.12, 6, 6), mat(0x888888), -0.6, 1.28, 0);
    add(new THREE.SphereGeometry(0.12, 6, 6), mat(0x888888),  0.6, 1.28, 0);
    add(new THREE.BoxGeometry(0.2, 0.42, 0.2), mat(dark), -0.6, 1.0, 0);
    add(new THREE.BoxGeometry(0.2, 0.42, 0.2), mat(dark),  0.6, 1.0, 0);
    ...
    add(new THREE.BoxGeometry(0.07, 0.22, 0.07), mat(0x888888),  0.68, 0.74, 0.05);
    add(new THREE.BoxGeometry(0.07, 0.22, 0.07), mat(0x888888),  0.52, 0.74, 0.05);
    add(new THREE.CylinderGeometry(0.15, 0.18, 0.2, 8), mat(dark), 0, 2.05, 0);
    add(new THREE.BoxGeometry(0.6, 0.5, 0.54), mat(color), 0, 2.45, 0);
    ...
    add(new THREE.BoxGeometry(0.24, 0.5, 0.26), mat(0x888888),  0.18, 0.43, 0);
    add(new THREE.BoxGeometry(0.2, 0.46, 0.06), mat(color), -0.18, 0.43, 0.14);
    add(new THREE.BoxGeometry(0.2, 0.46, 0.06), mat(color),  0.18, 0.43, 0.14);
    ...
    add(new THREE.BoxGeometry(0.28, 0.4, 0.28), mat(0x888888),  0.18, 0.98, 0);
    add(new THREE.BoxGeometry(0.2, 0.28, 0.1), mat(color), -0.24, 1.05, -0.1);
    add(new THREE.BoxGeometry(0.2, 0.28, 0.1), mat(color),  0.24, 1.05, -0.1);
    add(new THREE.BoxGeometry(0.72, 0.65, 0.42), mat(0x888888), 0, 1.6, 0);
    add(new THREE.BoxGeometry(0.6, 0.55, 0.1), mat(color), 0, 1.62, 0.22);
    ...
    add(new THREE.SphereGeometry(0.22, 7, 7), mat(0x999999),  0.52, 1.92, 0);
    add(new THREE.SphereGeometry(0.15, 6, 6), mat(color), -0.52, 2.02, 0);
    add(new THREE.SphereGeometry(0.15, 6, 6), mat(color),  0.52, 2.02, 0);
    ...
    add(new THREE.BoxGeometry(0.08, 0.65, 0.5), mat(color), -1.05, 1.55, 0);
    ...
    add(new THREE.BoxGeometry(0.68, 0.65, 0.4), mat(color), 0, 1.52, 0);
    add(new THREE.BoxGeometry(0.5, 0.18, 0.12), mat(Math.max(0, color - 0x222222)), 0, 1.88, 0.16);
    add(new THREE.BoxGeometry(0.2, 0.16, 0.08), mat(Math.max(0, color - 0x111111)), -0.22, 1.45, 0.22);
    add(new THREE.BoxGeometry(0.2, 0.16, 0.08), mat(Math.max(0, color - 0x111111)),  0.22, 1.45, 0.22);
    add(new THREE.CylinderGeometry(0.11, 0.13, 0.62, 6), mat(color), -0.52, 1.52, 0, 0, 0, 0.12);
    add(new THREE.CylinderGeometry(0.11, 0.13, 0.62, 6), mat(color),  0.52, 1.52, 0, 0, 0, -0.12);
...
socket.on('init', (players) => {
  for (const id in players) {
    ...
    if (id === socket.id) {
      myColor  = p.color;
      myPlayer = makeAvatar(myColor, googleUser.name, selectedAvatar);
